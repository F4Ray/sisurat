         ...
         <form action="#" id="form_add" class="form-horizontal">
            ...
            <div class="row">
              <div class="col-md-8 col-sm-12 col-xs-12">
                <div class="form-body">
                  <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-3">No</label>
                    <div class="col-md-3 col-sm-7 col-xs-7">
                      <input name="no" placeholder="No" class="form-control" type="number">
                    </div>
                    <div class="col-md-2 col-sm-2 col-xs-2">
                      <button type="button" class="btn btn-sm btn-info" onclick="cek_no()">Cek</button>
                    </div>
                  </div>
                </div>
                <div class="form-body">
                  <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-3">Kode Surat</label>
                    <div class="col-md-9 col-sm-7 col-xs-7">
                      <input name="kode" placeholder="Kode Surat" class="form-control" type="text">
                    </div>
                  </div>
                </div>
                <div class="form-body">
                  <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-7 col-xs-7">
                      <textarea class="form-control" name="kepada"></textarea>
                    </div>
                  </div>
                </div>
                <div class="form-body">
              ...
              <div class="col-md-4 col-sm-12 col-xs-12 text-center">
                ...
                <p>
                  <ol>
                    <li>Silahkan klik cek untuk melihat nomor surat yang tersedia</li>
                    <li>Jika nomor surat tidak sesuai bisa di ganti dengan yang di inginkan</li>
                  </ol>
                </p>
              </div>
            </div>
