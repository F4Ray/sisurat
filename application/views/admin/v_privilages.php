      ...
      <div class="modal-content">
        ...
        <div class="modal-body form">
         <form action="#" id="form_add" class="form-horizontal">
            <input type="hidden" value="" name="inputIdPriv"/>
            <div class="form-body">
              <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-3">Name Privilages</label>
                <div class="col-md-7 col-sm-7 col-xs-7">
                  <input name="inputDescPriv" placeholder="Name Privilages" class="form-control" type="text">
                </div>
              </div>
            </div>
            <div class="form-body">
              <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-3">Description more</label>
                <div class="col-md-7 col-sm-7 col-xs-7">
                  <textarea class="form-control" name="inputDescPrivMore"></textarea>
                </div>
              </div>
            </div>
          </form>
